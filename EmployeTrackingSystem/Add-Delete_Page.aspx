  ...
  <body class="bg-light">
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <form class="d-flex">
            ...
            <asp:Button
              ID="btn_logout_add_delete"
              runat="server"
              Text="Log out"
              class="nav-link btn btn-danger"
              aria-current="page"
              ForeColor="White"
              OnClick="btn_logout_add_delete_Click"
            />
          </form>
        </div>
      </div>
    ...
    <div class="container" style="margin-top: 80px">
      <div class="form-group card col-6 mx-auto px-4 justify-content-center shadow">
        ...
        <div class="mb-3 row justify-content-center p-2">
            <asp:Button
                    ID="btn_add_emp"
                    runat="server"
                    Text="Add"
                    class="btn btn-primary col-sm-5 mx-1"
                  ...
                  <asp:Button
                    ...
                    runat="server"
                    Text="Delete"
                    class="btn btn-danger col-sm-5 mx-1"
