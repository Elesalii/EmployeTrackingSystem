<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="EmployeTrackingSystem.HomePage" %>
  ...
  <body class="text-center">
    <form class="form-signin" runat="server">
      ...
      <label for="inputPassword" class="sr-only">Password</label>
        ...
        <asp:Label ID="errorLabel" runat="server" Text="Incorrect Username or password" Font-Bold="True" Font-Italic="True" Font-Overline="False" Font-Underline="False" ForeColor="Red" Visible="False"></asp:Label>
